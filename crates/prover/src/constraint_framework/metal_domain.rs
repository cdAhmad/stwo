...
use crate::core::backend::metal::column::VeryPackedBaseColumn;
use crate::core::backend::metal::m31::LOG_N_LANES;
use crate::core::backend::metal::very_packed_m31::{
...
pub struct MetalDomainEvaluator<'a> {
    pub trace_eval:
        &'a TreeVec<Vec<&'a CircleEvaluation<MetalBackend, BaseField, BitReversedOrder>>>,
...
impl<'a> MetalDomainEvaluator<'a> {
    pub fn new(
        trace_eval: &'a TreeVec<Vec<&CircleEvaluation<MetalBackend, BaseField, BitReversedOrder>>>,
        vec_row: usize,
...
impl EvalAtRow for MetalDomainEvaluator<'_> {
