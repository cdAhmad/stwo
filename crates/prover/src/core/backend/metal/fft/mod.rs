...
fn mul_twiddle(v: PackedBaseField, twiddle_dbl: u32x16) ->  PackedBaseField {
    ...
    cfg_if::cfg_if! {
        if #[cfg(all(target_arch = "aarch64", target_feature = "neon"))] {
            ...
            crate::core::backend::metal::m31::mul_doubled_neon(v, twiddle_dbl)
        } else if #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))] {
            crate::core::backend::metal::m31::mul_doubled_wasm(v, twiddle_dbl)
        } else if #[cfg(all(target_arch = "x86_64", target_feature = "avx512f"))] {
            crate::core::backend::metal::m31::mul_doubled_avx512(v, twiddle_dbl)
        } else if #[cfg(all(target_arch = "x86_64", target_feature = "avx2"))] {
            crate::core::backend::metal::m31::mul_doubled_avx2(v, twiddle_dbl)
        } else {
            crate::core::backend::metal::m31::mul_doubled_simd(v, twiddle_dbl)
        }
    }
}
