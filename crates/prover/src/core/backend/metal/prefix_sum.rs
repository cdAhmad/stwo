...
use crate::core::backend::metal::m31::{PackedBaseField, N_LANES};
...
pub fn inclusive_prefix_sum(
    bit_rev_circle_domain_evals: Col<MetalBackend, BaseField>,
) -> Col<MetalBackend, BaseField> {
...
mod tests {
    ...
    use crate::core::backend::metal::prefix_sum::inclusive_prefix_sum_slow;
